...
var tokenProviders = __webpack_require__(94440);
...
const resolveSSOCredentials = async ({ ssoStartUrl, ssoSession, ssoAccountId, ssoRegion, ssoRoleName, ssoClient, clientConfig, parentClientConfig, callerClientConfig, profile, filepath, configFilepath, ignoreCache, logger, }) => {
    ...
    const { SSOClient, GetRoleCredentialsCommand } = await Promise.resolve().then(function () { return __webpack_require__(68702); });
    const sso = ssoClient ||
...
var sso = __webpack_require__(20373);
...
const bdd_1 = __webpack_require__(57181);
...
var httpAuthSchemeProvider = __webpack_require__(79654);
var runtimeConfig = __webpack_require__(26527);
var regionConfigResolver = __webpack_require__(43140);
var protocolHttp = __webpack_require__(23643);
var schemas_0 = __webpack_require__(93621);
var errors = __webpack_require__(90953);
var SSOServiceException = __webpack_require__(81095);
...
const SSOServiceException_1 = __webpack_require__(81095);
...
const runtimeConfig_shared_1 = __webpack_require__(55756);
...
const httpAuthSchemeProvider_1 = __webpack_require__(79654);
const endpointResolver_1 = __webpack_require__(80672);
const schemas_0_1 = __webpack_require__(93621);
const getRuntimeConfig = (config) => {
    return {
...
const errors_1 = __webpack_require__(90953);
const SSOServiceException_1 = __webpack_require__(81095);
...
const getSsoOidcClient = async (ssoRegion, init = {}, callerClientConfig) => {
    const { SSOOIDCClient } = await __webpack_require__.e(/* import() */ 702).then(__webpack_require__.t.bind(__webpack_require__, 86321, 23));
...
const getNewSsoOidcToken = async (ssoToken, ssoRegion, init = {}, callerClientConfig) => {
    const { CreateTokenCommand } = await __webpack_require__.e(/* import() */ 702).then(__webpack_require__.t.bind(__webpack_require__, 86321, 23));
