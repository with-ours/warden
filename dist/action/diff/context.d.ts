 ...
 */
export declare function expandHunkContext(repoPath: string, filename: string, hunk: DiffHunk, options?: number | ExpandContextOptions): HunkWithContext;
/**
 * Expand all hunks in a parsed diff with context.
 */
export declare function expandDiffContext(repoPath: string, diff: ParsedDiff, options?: number | ExpandContextOptions): HunkWithContext[];
/**
