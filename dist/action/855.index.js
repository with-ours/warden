...
const property_provider_1 = __webpack_require__(24717);
const shared_ini_file_loader_1 = __webpack_require__(50263);
const node_fs_1 = __webpack_require__(73024);
const fromWebToken_1 = __webpack_require__(95308);
...
const fromWebToken = (init) => async (awsIdentityProperties) => {
    ...
    if (!roleAssumerWithWebIdentity) {
        const { getDefaultRoleAssumerWithWebIdentity } = await Promise.resolve().then(() => __importStar(__webpack_require__(72886)));
...
var fromTokenFile = __webpack_require__(33676);
var fromWebToken = __webpack_require__(95308);
