...
/* harmony import */ var zod__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(19002);
...
const RemoteEntrySchema = zod__WEBPACK_IMPORTED_MODULE_5__.object({
    sha: zod__WEBPACK_IMPORTED_MODULE_5__.string(),
    fetchedAt: zod__WEBPACK_IMPORTED_MODULE_5__.string().datetime(),
    cloneUrl: zod__WEBPACK_IMPORTED_MODULE_5__.string().optional(),
});
/** Schema for the entire state.json file */
const RemoteStateSchema = zod__WEBPACK_IMPORTED_MODULE_5__.object({
    remotes: zod__WEBPACK_IMPORTED_MODULE_5__.record(zod__WEBPACK_IMPORTED_MODULE_5__.string(), RemoteEntrySchema),
});
/** Schema for a plugin in marketplace.json */
const MarketplacePluginSchema = zod__WEBPACK_IMPORTED_MODULE_5__.object({
    name: zod__WEBPACK_IMPORTED_MODULE_5__.string(),
    source: zod__WEBPACK_IMPORTED_MODULE_5__.string(),
...
const MarketplaceConfigSchema = zod__WEBPACK_IMPORTED_MODULE_5__.object({
    $schema: zod__WEBPACK_IMPORTED_MODULE_5__.string().optional(),
    name: zod__WEBPACK_IMPORTED_MODULE_5__.string(),
    description: zod__WEBPACK_IMPORTED_MODULE_5__.string().optional(),
    plugins: zod__WEBPACK_IMPORTED_MODULE_5__.array(MarketplacePluginSchema),
});
/**
